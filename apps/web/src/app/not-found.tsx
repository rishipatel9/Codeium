    ...
    <div className="flex min-h-screen flex-col">
      <main className="flex flex-1 flex-col items-center justify-center p-8 text-center text-white bg-black">
        ...
        <Button asChild size="lg">
          <Link
            href="/"
            className="inline-flex h-10 items-center justify-center rounded-md bg-[white] text-black bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
          >
            Go Back Home
          </Link>
        </Button>
