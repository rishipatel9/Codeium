    ...
    return (
        <Link href="https://github.com/rishipatel9/Codeium" passHref>
            <RainbowButton
                ...
                <p className='px-2 hidden md:inline-flex'>Star on Github</p>
                <Star className="mr-2 h-5 w-5 transition-colors duration-300 group-hover:fill-yellow-500 hidden md:inline-flex" />
            </RainbowButton>
        </Link>
    );
};
